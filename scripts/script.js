...
(function() {
    ...
    var svg = d3.select("body")
        .insert("svg")
        .attr("viewBox", "-20 0 " + parseInt(winWidth + 40, 10) + " " + winHeight);
    ...
    main.append("text")
        ...
        .attr("text-anchor", "left")
        .attr("y", function() {
            return winHeight / 2 + subTextOffset;
        });
    ...
    var groups = svg.append("g").selectAll("circle")
        ...
        .data(pack(seriesdata).filter(function(d) {
            return !d.children;
        }))
        .enter()
        .append("g");
